...
export default function ResetUser() {
    ...
    const validationSchema = yup.object().shape({
        ...
        newPassword: yup.string().required('Password Is Requried').matches(/^[A-z0-9_]{6,30}$/, 'Please Enter Valid Password With (numbers / _ / characters)')
      ...
      <div className="container">
        ...
        <form className="relative w-[75%] mx-auto shadow p-8 bg-[#f0f3f2] rounded-md " onSubmit={formik.handleSubmit}>
          ...
          {formik.errors.newPassword && formik.touched.newPassword ?
            <div className=" mb-4 text-sm text-red-800 rounded-lg  dark:bg-gray-800 dark:text-red-400" role="alert">
